...
<div class="product-details"><!--product-details-->
	<div class="col-sm-5">
		<div class="view-product">
			<img src="{{URL::to('/public/uploads/product/'.$pro_details->product_image)}}" alt="" />
			<h3>ZOOM</h3>
		</div>
	...
	<div class="col-sm-7">
		<div class="product-information"><!--/product-information-->
			...
			<p>Ma san pham: {{$pro_details->product_id}}</p>
			...
			<span>
				...
				<input name="productidhidden" type="hidden" value="{{$pro_details->product_id}}" />
			...
			<p><b>Danh mục:</b> {{$pro_details->category_name}} </p>
